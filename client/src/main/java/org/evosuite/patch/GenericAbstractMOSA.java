...
public abstract class GenericAbstractMOSA<T extends Chromosome<T>> extends GeneticAlgorithm<T>  {

//    private static final long serialVersionUID = 146182080947267628L;

    private static final Logger logger = LoggerFactory.getLogger(GenericAbstractMOSA.class);
    ...
    protected final List<FitnessFunction<T>> fitnessFunctions = new ArrayList<>();
...
//    protected final BudgetConsumptionMonitor budgetMonitor;
     ...
     */
    public GenericAbstractMOSA(ChromosomeFactory<T> factory) {
        super(factory);
...
//				tch.mutate(); // TODO why is it mutated twice?
     ...
     * @return
     */
    protected List<T> breedNextGenerationWithoutEvaluation() {
        List<T> offspringPopulation = new ArrayList<>(Properties.POPULATION);
        // we apply only Properties.POPULATION/2 iterations since in each generation
        // we generate two offsprings
        for (int i = 0; i < Properties.POPULATION / 2 && !this.isFinished(); i++) {
...
//				tch.mutate(); // TODO why is it mutated twice?
    ...
    protected void postCalculateFitness(List<T> population) {
        population.stream().filter(T::isChanged).forEach(this::calculateFitness);
    }
...
//    }
    ...
    public List<T> getNonDominatedSolutions(List<T> solutions) {
        final DominanceComparator<T> comparator =
...
//            List<T> seeds = SeedHandler.getInstance().loadSeedTestPopulation();
            List<T> seeds = getSeeds();
    ...
    protected abstract List<T> getSeeds();
     ...
     * @return
     */
    abstract protected Set<FitnessFunction<T>> getCoveredGoals();
//    {
...
//    }
     ...
     * @return
     */
    abstract protected int getNumberOfCoveredGoals();
//    {
//        return Archive.getArchiveInstance().getNumberOfCoveredTargets();
//    }

    abstract protected void addUncoveredGoal(FitnessFunction<T> goal);
//    {
...
//    }
     ...
     * @return
     */
    abstract protected Set<FitnessFunction<T>> getUncoveredGoals();
//    {
...
//    }
     ...
     * @return
     */
    abstract protected int getNumberOfUncoveredGoals();
//    {
...
//    }
     ...
     * @return
     */
    abstract protected int getTotalNumberOfGoals();
//    {
...
//    }
     ...
     * @return
     */
    abstract protected List<T> getSolutions();
//    {
