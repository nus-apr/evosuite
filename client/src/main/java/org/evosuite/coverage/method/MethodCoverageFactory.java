    ...
    public List<MethodCoverageTestFitness> getCoverageGoals() {
        ...
        if (clazz != null) {
            ...
            for (Class<?> innerClass : innerClasses) {
                // TODO: Investigate for possible side-effects
                //  This fixes an inconsistency with the class+method name generated by the MultiCriteriaManager
                //  when generating method goal dependencies (inner class contains $, where canonical names don't)
